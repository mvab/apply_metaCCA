...
with_trait<- read_tsv(paste0(data_path, "results/test_result_w11_r_2M_UKB/metaCCA_snps_all_UKB_annotated_w_traits.tsv")) %>% 
...
merged_r$r_diff<-round(abs(merged_r$r_1_ukb - merged_r$r_1_giant),2)
merged_r$p_diff<-round(abs(merged_r$pval_ukb - merged_r$pval_giant),2)
