...
#data_path<-"/projects/MRC-IEU/research/projects/ieu2/p4/041/working/data/" #to use in terminal
ref<-read.table(paste0(data_path,"genotype_matrix_4/annotated_genes.txt"), header=T, stringsAsFactors = F)
dim(ref)
```
...
for (chr in c(1:22)) {
  ...
  #load matrix for chr
  ld_matrix <- paste0(data_path, "genotype_matrix_4/ld_matrix_by_chr/ld_matrix_chr", chr, ".ld")
